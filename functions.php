...
function pictorico_setup() {
	...
	add_image_size( 'pictorico-slider', '1180', '525', array( 'center', 'center' )  );
	add_image_size( 'pictorico-single', '1500', '525', array( 'center', 'center' )  );
...
function insert_image_src_rel_in_head() {
	...
	if(!has_post_thumbnail( $post->ID )) { //the post does not have featured image, use a default image
		$default_image="http://jonathanlurie.fr/wp-content/uploads/2015/06/raquettes-12.jpg"; //replace this with a default image on your server or an image in your media library
